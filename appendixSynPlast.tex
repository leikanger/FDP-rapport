...
This influx of calcium is graded by the potential over the presynaptic membrane, and thus causes the effect of axo-axonic synapses in regulating the amount of neurotransmitter release at the next transmissions\cite{PrinciplesOfNeuralScience4edKAP14}.%LENGER syn.p. kan komme av langtidsvirkning av at denne kanalen slepp gjennom meir Ca^2+
