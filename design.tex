...
\section{Design} % eller "Design; General Consepts for both Imlementations" eller noke anna..
	...
	%The function that is resposnible for the node's temporal behaviour is the function \emph{doTask()}.
	As every object of a \emph{time\_interface} derived class have defined its variant of this function, we can let this function be the function called by a global task--scheduler function. %XXX skriv at har tatt med koden i appendix?
...
% 		Evt. : Serial time simulation could be implemented by having one task list for each new time iteration. 
	...
	% Dersom det neste blå gjøres: (oog det skal det..)  Nevn såvidt at dette designet gjør programmet velegnet for distribuert programmering.
	...
	%FLYTT  OVER I diskurs! (neste linjene, før koden)
	% TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO 
...
%HER ELLER UNDER subsection{Biologisk nært}
	...
	\label{ssecTheGeneralDesign}
		...
		Inspired by this observation, the general design of each node will % for both implementations
	...
	% HER PASSER DET seg veldig bra med en figur (Her trengs det en figur. For mykje tett tekst, for lenge..)
		...
		As we have seen in sec. \ref{ssecTime}, the \emph{s\_auron} is therefore responsible for initiating the simulated action potential       by inserting a pointer to the axon to \emph{pWorkTaskQue}. %lat til den siste eg. Passer det?
...
% TODO Vurder å fjærne heile subsubsection:
...
%	As we will se next, combined with a smaller time step, this would give an increased spatiotemporal resolution.
...
% //}
	...
	\subsubsection{The object design}
%	%Also implementation specific reasons exist. XXX SKRIV DETTE FØRST
%	This design introduces a some new challanges for the implementation. 
%	If each \emph{soma} has one pointer to a dendrite object and an axon object (located in the free store), destruction of one of these objects (e.g. the axon) will need to signal the \emph{soma}. 
%	The \emph{soma} is then responsible to take action to avoid memory exhaustion and undefined behavior following calls to the deleted object. %få med at det er peiker-kall, og obj. er sletta
