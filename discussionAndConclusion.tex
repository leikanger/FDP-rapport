...
% XXX ER Ikkje dette conclusion?
	\subsection{Discussion about the differences in the Elements} %TODO Endre tittel!
		As the SANN model is a direct simulation of each node's depolarization, this requires the design used in this project.
		...
		Time delays spanning multiple time iterations can be implemented by laying multilre elements in series.
