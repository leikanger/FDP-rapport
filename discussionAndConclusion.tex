...
% %An other aspect that was developed for this project was the concept of time scheduling as done in $\kappa$ANN.
...
\section{Discussion } % TODO Skriv tittel!
...
%Efficiancy was not tested in this project. The behaviour of single nodes was, and it was compared on elements that SANN was able to provide.
Only the behaviour of the single node was compared, not the efficiancy of a network of nodes. 
...
%Skriv at kompleksiteten gjør desse result. litt usikre. (spess "certain" er usikkert kva innebærer)
...
%As the neuron often is modelled as a leaky integrate--and--fire 
...
By the use of these methods, an ANN is developed, and compared theoretically with the SANN model. % XXX ... theoretically AND EXPERIMENTALLY with the ... ?
% % %
