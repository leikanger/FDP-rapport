...
\chapter{implementasjon: KANN}
	...
	\section{Updating $\kappa$} %Calculation and recalculation of $\kappa$
		...
		\subsection{Synaptic input to a node}
			...
			%Efficiency is important in artificial neural networks,
			...
			When $\kappa_i$ changes for a node of the $\kappa$ANN, it is important to recalculate the inverse of the period for this new $\kappa_i$ to get the synaptic transmissions right.
...
\end{lstlisting}
			...
			%Først sørger den for at kvart elment bare er oppført ein gang i pCalculateTaskQue. Så

			%TODO skriv også om at eg venter med å rekalkulere kappa til etter gjeldende tidsiterasjon.
