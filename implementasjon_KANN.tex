...
%		We call the size of this transmission for $\kappa_{ij}$.
		...
		\subsection{The Postsynaptic Effect of Synaptic Transmissons}
			...
			%A discussion 
			% FEIL: The choice for this implementation is presented in the next section (sec. \ref{ssecImplementationOfSynPlastKANN}).
	...
	%		Begynn med å skrive at det er er vankelig å vite når det skal skje. Diskuter litt fram og tilbake som intro til section. %TODO 
			...
			% TODO TODO todo todo todo todo todo todo todo todo todo todo todo todo todo todo todo  SKRIV OM DETTE (pCalculateTaskQue) i design.tex TODO TODO TODO
\begin{lstlisting}
...
% Setninger som inneheld aspekt som eg ikkje har dekka:
		...
		% uvisst kva delay før propagation av kappa skal være.
			...
			For an analysis of the time of propagation of $\kappa$ it is referred to section ?. %TODO TODO TODO OTODO OTDO TODO TODO TODOD TODO Skriv in referanse nå er har skrevet om dette i Analyse-kapittelet.
