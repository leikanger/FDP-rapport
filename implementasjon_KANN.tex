...
\end{figure}
	...
	\label{ssecSynTransForANNliggeriKANNsection}
		...
		As for temporally separated input, the synapses' total effect of multiple transmissions is modeled as a linear carracteristic. %TODO TODO Skriv kvifor / begrunn dette valget!
...
%		We call the size of this transmission for $\kappa_{ij}$.
		...
		\subsection{Design of Synaptic Transmission}
			...
			The synaptic transmission now becomes the integral of all the edge's transmissions, modeled by %eq. \eqref{eqSynapticTransmissionAsSumOfEdgeTransmissions}.      %, and is defined as
			\begin{equation}
	...
	%		Begynn med å skrive at det er er vankelig å vite når det skal skje. Diskuter litt fram og tilbake som intro til section. %TODO 
			...
			%In this implementation, $\kappa$ is used as the activity variable instead of the node's depolarization, and another transmission scheme needs to be devised.
