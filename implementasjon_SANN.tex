...
\label{secSANN} 
	...
	%Because of the object design of this implementaion (se section \ref{ssFINNES IKKJE LENGERecTheObjectDesign}), this delay can be implemented by using pWorkTaskQue.
