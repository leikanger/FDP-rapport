...
What is interesting about this curve is that we can see that the depolarization curve follows eachother exactly %Dette er rett: exactly (google translate)
for the rising phase of the sensor curve. For the falling phase of the sensor fuction, we get an error that varies with the derived of the sensor function curve.
When the sensor function decreases the most, we get an error of a couple of percent. %TODO finn dette nøyaktig, om det ikkje blir fikset!
