...
If we allow the activation level of the node to change during the inter--spike period of the neuron, we cannot directly use %\eqref{eqVerdiligninga} and \eqref{eqTidTilFyringVedEndraKappa}.
...
Within each time window both \eqref{eqVerdiligninga} and \eqref{eqTidTilFyringVedEndraKappa} is valid. % .. kan bli brukt.
